...
import { commands, VulkanDeviceLayer, VulkanInfo as VkInfo } from "../bindings";
          ...
          device.index === currentDevice ? (
            <Table isStriped shadow="none" fullWidth>
              ...
              <TableBody>
                ...
                <TableRow>
                  <TableCell className="font-bold w-1/3">Device Type</TableCell>
                  <TableCell className="font-mono">
                    {device.deviceType}
                  </TableCell>
                </TableRow>
                ...
                <TableRow>
                  <TableCell className="font-bold w-1/3">API Version</TableCell>
                  <TableCell className="font-mono">
                    {device.apiVersion}
                  </TableCell>
                </TableRow>
