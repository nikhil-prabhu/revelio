import { commands, MetalCounterSet, MetalInfo as MTLInfo } from "../bindings";
            ...
            <Table isStriped shadow="none" fullWidth>
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell className="font-mono">
                    {utils.formatBytes(device.maxThreadgroupMemoryLength)}
                  </TableCell>
                </TableRow>
                ...
                <TableRow>
                  ...
                  <TableCell className="font-mono">
                    {utils.formatBytes(device.recommendedMaxWorkingSetSize)}
                  </TableCell>
                </TableRow>
                ...
                <TableRow>
                  ...
                  <TableCell className="font-mono">
                    {utils.formatBytesPerSecond(device.maxTransferRate)}
                  </TableCell>
                </TableRow>
                ...
                <TableRow>
                  ...
                  <TableCell className="font-mono">
                    {device.supportsBarycentricCoordinates ? "Yes" : "No"}
                  </TableCell>
                </TableRow>
                ...
                <TableRow>
                  ...
                  <TableCell className="font-mono">
                    {device.supportsFunctionPointers ? "Yes" : "No"}
                  </TableCell>
                </TableRow>
                ...
                <TableRow>
                  ...
                  <TableCell className="font-mono">
                    {device.supportsDynamicLibraries ? "Yes" : "No"}
                  </TableCell>
                </TableRow>
                ...
                <TableRow>
                  <TableCell className="font-bold w-1/3">
                    Supports 32-bit MSAA?
                  </TableCell>
                  <TableCell className="font-mono">
                    {device.supports32bitMSAA ? "Yes" : "No"}
                  </TableCell>
                </TableRow>

                <TableRow>
                  <TableCell className="font-bold w-1/3">
                    Supports Query Texture LOD?
                  </TableCell>
                  <TableCell className="font-mono">
                ...
                <TableRow>
                  <TableCell className="font-bold w-1/3">
                    Supports BC Texture Compression?
                  </TableCell>
                  <TableCell className="font-mono">
                ...
                <TableRow>
                  <TableCell className="font-bold w-1/3">
                    Supports Pull Model Interpolation?
                  </TableCell>
                  <TableCell className="font-mono">
                ...
                <TableRow>
                  ...
                  <TableCell className="font-mono">
                    {utils.formatBytes(device.currentAllocatedSize)}
                  </TableCell>
                </TableRow>
                ...
                <TableRow>
                  ...
                  <TableCell className="font-mono">
                    {utils.formatBytes(device.maxBufferLength)}
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
          ...
          title={
            <div className="flex items-center space-x-2">
              ...
              <Chip size="sm" variant="faded" color="primary">
                {getCurrentDeviceCounterSets().length}
              </Chip>
            </div>
          }
