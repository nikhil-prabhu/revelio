import {DisplaysInfo, commands} from "../bindings";
...
function Displays() {
    ...
    useEffect(() => {
        commands.getDisplaysInfo().then(info => {
                    ...
                    <Card>
                        ...
                        <CardBody>
                            <Table hideHeader removeWrapper>
                                ...
                                <TableBody>
                                    <TableRow key={1}>
                                        <TableCell className="font-bold w-1/2">Dimensions</TableCell>
                                        <TableCell>{display.dimensions}</TableCell>
                                    </TableRow>

                                    <TableRow key={2}>
                                        <TableCell className="font-bold w-1/2">Scale Factor</TableCell>
                                    ...
                                    <TableRow key={4}>
                                        <TableCell className="font-bold w-1/2">Refresh Rate</TableCell>
